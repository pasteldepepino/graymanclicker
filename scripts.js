var clicks = 0, mny1 = 0, mny2 = 0, dblclck = 0, multiclickamount = 0, multiclck = 0 //sets the variable for the points, money skins, double click lock
...
function incrementclick() { //sets the function that will update the click counter when the click here! button is clicked
    ...
    if (multiclck == 1) {
            clicks += multiclickamount //checksa if multi click was bought
        }
